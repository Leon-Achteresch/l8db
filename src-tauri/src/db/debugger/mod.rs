...
pub fn unsupported(kind: DatabaseKind) -> Availability {
    let message = match kind {
        ...
        DatabaseKind::Clickhouse | DatabaseKind::Mongodb | DatabaseKind::Cassandra | DatabaseKind::Elasticsearch | DatabaseKind::Influxdb | DatabaseKind::Dynamodb | DatabaseKind::Athena => "Für diesen Provider ist keine unterstützte Stored-Routine-Debug-Schnittstelle verfügbar.",
    };
    Availability {
        available: false,
        engine: None,
