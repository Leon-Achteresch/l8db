...
pub fn unsupported(kind: DatabaseKind) -> Availability {
    let message = match kind {
        ...
        DatabaseKind::Clickhouse | DatabaseKind::Mongodb | DatabaseKind::Cassandra | DatabaseKind::Bigquery | DatabaseKind::Snowflake => "Für diesen Provider ist keine unterstützte Stored-Routine-Debug-Schnittstelle verfügbar.",
    };
    Availability {
        available: false,
        engine: None,
