...
function parseRef(ref: string, ds: SimpleDataset): { join: DatasetJoin | null; column: string } {
...
function aliasOf(join: DatasetJoin | null | undefined, joins: DatasetJoin[]): string {
